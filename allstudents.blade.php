   ...
   <ul class="submenu-angle" aria-expanded="false">
    ...
    <!--{{-- <form action="/listteachers" method="post"> --}}
        ...
        <div class="container-fluid">
                <div class="row" style="padding-left:200px;">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
						<h2 aria-align="center" style="color:#0000CC;"><u>Registered Students</u></h2>
        ...
        <table style="border: dotted #666666 ; width:60em; height:auto;"  >
            ...
            <tr style="border:dotted 1px; ">
                ...
                <td>
                    {{-- {{ $data->ustatus }} --}}
                @if($data->ustatus == 1)
<a class="btn btn-outline-primary ml-3" href="{{ url('Updatestudents/'.$data->rid)}}">Block</a> </td>
  @else
 <a class="btn btn-outline-primary ml-3" href="{{ url('Updatestudents/'.$data->rid)}}">UnBlock</a> </td>
 @endif
