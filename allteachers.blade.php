                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                            ...
                            <!--<ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="/adminindex"><span class="mini-sub-pro">Dashboard v.1</span></a></li>
                        ...
                        <li>
<li class="active">
   <a class="has-arrow" href="/allteachers" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap"></span> <span class="mini-click-non">Professors</span></a>
   <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Professors" href="/allteachers"><span class="mini-sub-pro">All Professors</span></a></li>
                        ...
                        <li>
                            <a class="has-arrow" href="/students" aria-expanded="false"><span class="educate-icon educate-student icon-wrap"></span> <span class="mini-click-non">Students</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Students" href="/students"><span class="mini-sub-pro">All Students</span></a></li>
                        ...
                        <li>
                            <a class="has-arrow" href="all-courses.php" aria-expanded="false"><span class="educate-icon educate-department icon-wrap"></span> <span class="mini-click-non">Subjects</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Departments List" href="departments.html"><span class="mini-sub-pro">Add Subjects</span></a></li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                <li><a href="/adminindex">Dashboard v.1</a></li>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demoevent" href="#">Professors <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demoevent" class="collapse dropdown-header-top">
                                                <li><a href="/allteachers">All Professors</a>
                                                </li>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demopro" href="#">Students <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demopro" class="collapse dropdown-header-top">
                                                <li><a href="/students">All Students</a>
                                                </li>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demodepart" href="#">Subjects <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demodepart" class="collapse dropdown-header-top">
                                                <li><a href="departments.html">Add Subjects</a>
                                                </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <li><a href="/adminindex">Home</a> <span class="bread-slash">/</span>
                                            </li>
    ...
    <!--{{-- <form action="/listteachers" method="post"> --}}
        {{-- displaying teachers in a table --}}-->

        <div class="container-fluid">
                <div class="row" style="padding-left:200px;">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
						<h2 aria-align="center" style="color:#0000CC;"><u>Registered Teachers</u></h2>

        <table style="border: dotted #666666 ; width:60em; height:auto;"  >
            <tr>


                <th style="border:dotted 1px; padding-top: .5em;padding-bottom: .5em;">First Name</th>

                <th style="border:dotted 1px; padding-top: .5em;padding-bottom: .5em;">Last Name</th>

                <th style="border:dotted 1px; padding-top: .5em;padding-bottom: .5em;">Email-Id</th>
                {{-- <th>School Name</th>
                <th>District</th> --}}

                <th style="border:dotted 1px;">Action</th>
            </tr><br>
            @isset($teachers)
            @foreach ($teachers as $data)
            <tr style="border:dotted 1px; ">
                <td style="border:dotted 1px;padding-top: .5em;padding-bottom: .5em;  ">{{$data->fname}}</td>
                <td style="border:dotted 1px;padding-top: .5em;padding-bottom: .5em;">{{$data->lname}}</td>
                <td style="border:dotted 1px;padding-top: .5em;padding-bottom: .5em;">{{$data->uname}}</td>
                <td>
                    {{-- {{ $data->ustatus }} --}}
                @if($data->ustatus == 1)
<a class="btn btn-outline-primary ml-3" href="{{ url('Updateteachers/'.$data->rid)}}">Block</a> </td>
  @else
 <a class="btn btn-outline-primary ml-3" href="{{ url('Updateteachers/'.$data->rid)}}">UnBlock</a> </td>
 @endif
                {{-- <th style="border:dotted 1px;padding-top: .5em;padding-bottom: .5em;"><a href=""> <div class="button-ap-list responsive-btn">
                                <div class="button-style-four btn-mg-b-10"><button type="button" class="btn btn-custon-rounded-four btn-primary">Block</button></a></div></div></th>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright © 2019. All rights reserved. Template by irene mary</a></p>
                        </div>
                    </div>
                </div>
            </div>
